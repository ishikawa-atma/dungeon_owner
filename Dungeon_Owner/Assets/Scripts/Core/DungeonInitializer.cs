...
namespace DungeonOwner.Core
{
    ...
    public class DungeonInitializer : MonoBehaviour
    {
        ...
        private void SetupInitialState()
        {
            ...
            // GameManagerの状態を設定
            if (DungeonOwner.Core.GameManager.Instance.CurrentState == GameState.MainMenu)
            {
                // メニューからゲーム開始への準備
        ...
        private void PrintInitializationInfo()
        {
            ...
            Debug.Log($"Game State: {DungeonOwner.Core.GameManager.Instance.CurrentState}");
            Debug.Log($"Game Speed: {DungeonOwner.Core.GameManager.Instance.GameSpeed}");
