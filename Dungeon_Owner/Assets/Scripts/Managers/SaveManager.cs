    ...
    public class SaveManager : MonoBehaviour
    {
       ...
       /// <summary>
        ...
        private SaveData CreateSaveData()
        {
            ...
            {
                saveData.currentFloor = DungeonOwner.Core.GameManager.Instance.CurrentFloor;
            }
            ...
            // インベントリ情報を取得
            if (DungeonOwner.Managers.InventoryManager.Instance != null)
            {
        ...
        private List<TrapItemSaveData> CreateInventoryList()
        {
            ...
            if (DungeonOwner.Managers.InventoryManager.Instance != null)
            {
                foreach (var item in DungeonOwner.Managers.InventoryManager.Instance.GetAllItems())
                {
        ...
        {
            if (inventoryDataList == null || DungeonOwner.Managers.InventoryManager.Instance == null) return;
            
            foreach (var itemData in inventoryDataList)
            {
                DungeonOwner.Managers.InventoryManager.Instance.RestoreItem(itemData);
            }
        }
    }
}